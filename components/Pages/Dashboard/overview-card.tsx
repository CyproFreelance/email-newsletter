...
//   }
  ...
  return (
    <div className="w-full xl:py-4 flex bg-a-2 border border-a-4 rounded">
      {/* subscribers */}
      <div className="w-[33.33%] border-r border-a-4 p-5 text-lg text-a-1">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="h-[30px] flex p-2 items-center bg-a-4 rounded-full">
            <span className="text-[#21C55D]">{ICONS.topArrow}</span>
            {/* <span className="text-sm pl-1">{comparePercentage}%</span> */}
            <span className="text-sm pl-1 ">65%</span>
          </div>
        </div>
      ...
      <div className="w-[33.33%] border-r border-a-4 p-5 text-lg text-a-1">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          <div className="h-[30px] flex p-3 items-center bg-a-4 rounded-full">
            <span className="text-xl text-a-1">-</span>
            <span className="text-sm pl-1 text-a-1">0%</span>
          </div>
        </div>
        <small className="block text-sm opacity-[.7] pt-2 text-a-1">
          from 0 (last 4 weeks)
        </small>
      </div>
      {/* Click Rate */}
